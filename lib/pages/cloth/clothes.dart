...
import 'package:cloth_shopping_app/helper/dependencies.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Column(children: [
          ...
          GetBuilder<ClothController>(
          
            builder: (cloth) {
            if(cloth.clothList!= null){
               debugPrint(cloth.clothList!.length.toString());

            }
           
            return cloth.isLoaded
                ? ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return Container(
                          padding: EdgeInsets.only(
                              right: 15, left: 15, top: 12, bottom: 15),
                          child: Row(
                            children: [
                              Container(
                                  height: 150,
